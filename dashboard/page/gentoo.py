...
def gentoo():
    st.title("Pinguino Gentoo")
    st.subheader("Este soy yo:")
    st.image('https://www.animalspot.net/wp-content/uploads/2017/02/Gentoo-Penguin-Pictures.jpg')
    ...
    if isla == "Dream":
        ...
        st.subheader(f"En la isla {isla} hay {len(get_island_by_penguin('Gentoo', isla))} pinguinos como yo!")
    elif isla == "Biscoe":
